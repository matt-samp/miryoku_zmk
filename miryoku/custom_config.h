...
// EXPERIMENTAL: True 42-key layout
// This may or may not work - the mapping might still expect 40 keys

// BASE LAYER - QWERTY with homerow mods and layer access  
// 42 keys total: 12 + 12 + 12 + 6 thumbs
...
&kp LSHFT,     &kp Z,         &kp X,         &kp C,         &kp V,         &kp B,         &kp N,         &kp M,         &kp COMMA,     &kp DOT,       &kp SLASH,     &kp PG_DN, \
                              &kp ESC,       &lt U_NUMBER DEL, &lt U_CURSOR BSPC, &lt U_SYMBOL SPACE, &kp RET,       &caps_word
